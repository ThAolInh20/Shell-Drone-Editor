...
## Example Prompts
- `/ds-update-structure-map`
- `/ds-update-structure-map src/systems`
- `Run ds-update-structure-map and refresh STRUCTURE.md from current src.`
